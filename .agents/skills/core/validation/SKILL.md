...
4. For application work, run static architecture and documentation checks before project-owned code. Confirm declared roots/modules, responsibilities, permitted extensions, dependency direction, thin composition roots, adapter or manual evidence, truth-index pointers, documentation impact, and release documentation. Unsupported semantic coverage is incomplete.
